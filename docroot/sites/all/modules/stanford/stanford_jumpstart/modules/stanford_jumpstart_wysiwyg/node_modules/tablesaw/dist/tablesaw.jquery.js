...
(function(){
	...
	function createSwipeTable( tbl, $table ){
		...
		var $prevBtn = $( "<a href='#' class='tablesaw-nav-btn btn btn-micro left' title='Previous Column'><span class='hide-me'>Previous Column</span></a>" ).appendTo( $btns );
		var $nextBtn = $( "<a href='#' class='tablesaw-nav-btn btn btn-micro right' title='Next Column'><span class='hide-me'>Next Column</span></a>" ).appendTo( $btns );
